<div class="stockentry">
    <div class="btns__left">
        <button type="button" class="maintenance_btn btn btn-primary btn-lg">Nuevo Ingreso <i class="bi bi-plus-circle"></i></button>
    </div>
...
<form action="/ruta/donde/enviar" method="POST" class="row g-3">
    <!-- Columna izquierda -->
    <div class="col-md-6">
        <label for="ordenVenta" class="form-label">Numero O/C</label> <button class="form_btn"><i class="bi bi-three-dots"></i></button>
