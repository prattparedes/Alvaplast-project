<div class="buyorder">
    <div class="btns__left">
        <button type="button" class="maintenance_btn btn btn-primary btn-lg">Generar Orden de Compra <i class="bi bi-plus-circle"></i></button>
    </div>
...
<form action="/ruta/donde/enviar" method="POST" class="row g-3">
  <div class="col-md-6">
    <label for="proveedor" class="form-label">Proveedor</label> <button class="form_btn"><i class="bi bi-three-dots"></i></button>
