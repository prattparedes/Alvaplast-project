...
<body>
    <header>
        ...
        <div class="container">
            ...
            <form>
                <b><span class="d-block p-2 col-12 bg-info text-white">Registro de compra</span></b>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label for="fechaDesdeProveedor" class="col-form-label">Desde:</label>
                        <input type="date" id="fechaDesdeProveedor" class="form-control" aria-describedby="passwordHelpInline">
                    </div>
                </div>
<br>
                <div class="row">
