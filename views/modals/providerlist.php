...
<span style="font-weight: 600; width:fit-content;">Filtrar por proveedor: <input type="text" style="width: 240px;" id="filtroproveedor" onkeyup="FiltrarListaProveedores()"></span><button class="modal__btn--search">Buscar</button>
...
<div class="modal__table--container">
    <table class="table" id="providertable">
        ...
        <tbody>
            <?php  require_once($_SERVER['DOCUMENT_ROOT']."/Alvaplast-project/Models/Mantenimiento/Proveedor.php");
