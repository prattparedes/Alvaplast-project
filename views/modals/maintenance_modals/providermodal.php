    ...
    <div style="flex: 40%; display: flex; flex-direction: column; gap: 10px; width:300px">
        <div style="display: flex; flex-direction: row; gap: 20px;">
            <div style="display: flex; flex-direction: column;">
                <label for="codigoPro">Código:</label>
                <span id="codigoPro">-</span>
            </div>
        ...
        <div style="margin-top: 16px; display:flex; justify-content: space-around; max-width:360px;">
            <button class="btn btn-primary provider_submit" style="width: 92px;" type="submit">Grabar</button>
            <button class="btn btn-primary provider_submit" style="width: 92px;" type="button">Modificar</button>
            <button class="btn btn-primary provider_submit" style="width: 92px;" type="button">Eliminar</button>
        </div>
    </div>
