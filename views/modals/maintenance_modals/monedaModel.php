            ...
            <div class="kardex__left">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <button style="width: 80px;" id="btnGrabar" class="btn btn-success order__btn--inactive money_submit" type="button" onclick="botónGrabarMantenimiento('1')">Grabar</button>
                        ...
                        <button style="width: 80px;" id="btnEliminar" class="btn btn-danger order__btn--inactive money_submit" type="button" onclick="botónEliminarMantenimiento('2')">Eliminar</button>
