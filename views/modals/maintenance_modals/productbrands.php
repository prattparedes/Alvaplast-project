...
<div style="display: flex; gap: 20px; max-width:1200px; margin: 0 auto; padding-left:120px;">
    <div style="flex: 40%; display: flex; flex-direction: column; gap: 10px; width:300px">
        ...
        <div style="margin-top: 16px; display:flex; justify-content: space-around; max-width:360px;">
            <button class="btn btn-primary brand_submit" style="width: 92px;" type="submit">Grabar</button>
            <button class="btn btn-primary brand_submit" style="width: 92px;" type="button">Modificar</button>
            <button class="btn btn-primary brand_submit" style="width: 92px;" type="button">Eliminar</button>
    ...
    <div style="flex: 60%; width:500px; border-left:1.25px solid lightgray; padding-left: 16px;">
        ...
        <div class="table--container" style="max-height:500px;">
            <table border="1" style="width:100%;" id="brandsTable" class="table table__maintenance">
                ...
                <tbody>
                    <?php
                    require_once($_SERVER['DOCUMENT_ROOT'] . "/Alvaplast-project/Models/Mantenimiento/Marca.php");
