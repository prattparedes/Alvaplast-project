    ...
    <header>
        ...
        <div class="kardex__movement">
            <div class="kardex__left">
                ...
                <div class="row">
                    <h5 style="background: black; color: white; text-align:center;">LISTADO ORDEN DE COMPRA PROVEEDORES</h5>
                    ...
                    <div class="col-12">
                        ...
                        <button style="width: 150px;margin-top: 10px;" class="btn btn-danger" onclick="loadContent('views/inventario/ingresokardex.php')" type="button" id="">Cancelar</button>
                    </div>
                </div>
                <br>
