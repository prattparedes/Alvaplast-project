            ...
            <div class="kardex__left">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <button style="width: 150px;" class="btn btn-danger" onclick="loadContent('views/reportes/ventasxcliente.php')" type="button" id="">Cancelar</button>
                                ...
                                <table class="table border=1" id="clienttable">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($clients as $client) { ?>
                                            <tr onclick="seleccionarClienteReporteCliente(this)">
