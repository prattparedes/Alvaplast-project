<h2 style="text-align:center;">REGISTRO DE FACTURACIONES</h1>
    <h4>Filtro: </h4>
    ...
    <table class="table">
        ...
        <tbody>
            <?php
            require_once($_SERVER['DOCUMENT_ROOT'] . '/Alvaplast-project/Models/Operaciones/Ventas/Facturacion/Facturacion.php');
