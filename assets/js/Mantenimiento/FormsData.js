...
document.querySelector(".main__content").addEventListener("click", function (event) {
    ...
    if (event.target.classList.contains("client_submit")) {
        event.preventDefault();
        // Obtener los datos del formulario
        const idCliente = document.getElementById("codigoCli").innerText;
        ...
        // Crear una solicitud XMLHttpRequest
        const xhr = new XMLHttpRequest();
        const url = "/Alvaplast-project/Controller/Mantenimiento/ClienteController.php"; // Ruta del controlador PHP
